  ...
  <div class="row">
    ...
    <div id="buttons" class="col-4">
      <div class="d-grid mw-100 gap-2 mr-2 d-md-block">
        ...
        <br />
        <button type="button" class="btn btn-outline-light">Candidates</button>
        <button type="button" class="btn btn-outline-light bg-blue">
          Contacts
        </button>
        <button type="button" class="btn btn-outline-light">Companies</button>
        <br />
        <button type="button" class="btn btn-outline-light" style="width: 100%">
          Submissions
        </button>
        <h5>Delivery Methods</h5>
        <button type="button" class="btn btn-outline-light" style="width: 50%">
          Email
        </button>
        <button type="button" class="btn btn-outline-light" style="width: 50%">
          Slack
